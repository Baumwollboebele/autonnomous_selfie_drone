"""
This module contains all constants needed for the project.
"""
...
class Constants():
    ...
    def DRONE_SPEED_X(self) -> int:
        """
        The function returns the setting for the drones movement in the
    ...
    def DRONE_SPEED_Y(self) -> int:
        ...
        Movement is measured in centimeters and can be set from
        -100 (down) to 100 (up).
    ...
    def DRONE_SPEED_TURN(self) -> int:
        ...
        Rotation is measured in degree and can be set from
        -100 (counterclockwise) to 100 (clockwise)
    ...
    def SELFIE_DELAY(self) -> int:
        """The Function returns the setting for the delay time, after which
        the drone will take a selfie.
