...
\begin{titlepage}
	...
	\HRule \\[0.4cm]
	{ \huge \bfseries Autonomous selfi drone using pose recognition}\\[0.4cm] % Title of your document
	\HRule \\[1.5cm]
...
Blaze Pose \cite{BLP_GITHUB} \cite{DBLP:journals/corr/abs-2006-10204} %\cite{Xu_2020_CVPR}
